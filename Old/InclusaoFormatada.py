...
# Escreve os dados com o formato das células
    for row_num, row_data in df_final.iterrows():
        for col_num, value in enumerate(row_data):
            # Trata explicitamente os valores None ou NaN
            if pd.isna(value):
...
print(f"Total de {qt_arquivos} novos arquivos processados e adicionados (se não existentes) à planilha '{NOME_ARQUIVO_EXCEL}' com formatação (cabeçalho, dados centralizados e bordas).")